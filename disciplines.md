...
WHY раскрывает основание, смысл и намерение системы.
...
# Дисциплины как проявление способности системы

Дисциплины показывают, какие формы деятельности становятся возможными благодаря реализации WHY через HOW.
...
Они являются результатом архитектурных решений и способов реализации.
...
Disciplines — это результат реализации намерения системы через архитектуру и способы действия.
