...
- как находить нужную информацию;
- как связывать разрозненные знания;
- как превращать опыт в повторно используемые знания;
- как проверять знания;
- как управлять их актуальностью;
- как использовать знания для принятия решений.
...
- Knowledge Discovery (исследование знаний);
- Knowledge Capture (захват знаний);
- Knowledge Structuring (структурирование знаний);
- Knowledge Retrieval (поиск и извлечение знаний);
- Knowledge Synthesis (синтез знаний);
- Knowledge Sharing (обмен знаниями);
- Knowledge Validation (проверку знаний);
- Knowledge Maintenance (поддержание актуальности знаний);
- Knowledge Reuse (повторное использование знаний).
...
- различать информацию и достоверное знание.
...
- структурирование экспертного опыта;
